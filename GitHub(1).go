...
1)"git merge" "имя ветки" - команда,которая производит слияние данной ветки,на ветку,в которой мы находимся
(в виде одного коммита)

2)"git rebase" "имя ветки" - команда, которая перемещает все коммиты из выделенной ветки в ту,в которой сейчас находимся