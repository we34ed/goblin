...
//TODO:Модули(набор пакетов Go со встроенным управлением версиями,который можно опубликовать)
...
4.1)в браузере по адресу "localhost:8080" мы увидим документацию ко всем пакетам
